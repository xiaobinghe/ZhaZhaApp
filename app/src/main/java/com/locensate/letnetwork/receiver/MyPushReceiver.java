...
//                    .setContentText("" + bundle.getString(JPushInterface.EXTRA_MESSAGE))
                        .setContentText("Let电机云:"+bundle.getString(JPushInterface.EXTRA_MESSAGE))
                        .setContentTitle("您有新消息")
//                    .setVibrate(VIBRATE) //设置通知到来时的震动提示
                        .setAutoCancel(true)
                        .setContentIntent(getPendingIntent(App.getApplication()));
...
//        intent.setFlags(PendingIntent.FLAG_UPDATE_CURRENT);
        return PendingIntent.getActivity(context, 0050, msgIntent, PendingIntent.FLAG_UPDATE_CURRENT);
    }
