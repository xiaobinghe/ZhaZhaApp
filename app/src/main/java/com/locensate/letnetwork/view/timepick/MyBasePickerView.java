...
public class MyBasePickerView {
    ...
    public Animation getInAnimation() {
        return AnimationUtils.loadAnimation(context, gravity == Gravity.BOTTOM ? R.anim.picker_fade_in : -1);
    }

    public Animation getOutAnimation() {
        return AnimationUtils.loadAnimation(context, gravity == Gravity.BOTTOM ? R.anim.picker_fade_out : -1);
    }
    ...
    public MyBasePickerView setKeyBackCancelable(boolean isCancelable) {
    ...
    public void createDialog() {
        if (dialogView != null) {
            ...
            mDialog.getWindow().setWindowAnimations(R.style.MyPickerview_dialogAnim);
