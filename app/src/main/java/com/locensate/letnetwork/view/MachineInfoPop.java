...
public class MachineInfoPop extends PopupWindow {
    private AddPopItemListener addPopItemListener;

    public MachineInfoPop(final Activity context, int resId, final OnItemClickListener onItemClickListener) {
    ...
    public void showPopupWindow(View parent) {
        if (!this.isShowing()) {
            // 以下拉方式显示popupwindow
            this.showAsDropDown(parent, 5, 3);
        } else {
            this.dismiss();
        }
    }
