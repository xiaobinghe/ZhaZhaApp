package com.locensate.letnetwork.view.timepick;
...
public class MyTimePickerView extends MyBasePickerView implements View.OnClickListener {
    ...
    public enum Type {
        ALL, YEAR_MONTH_DAY, HOURS_MINS, MONTH_DAY_HOUR_MIN, YEAR_MONTH, YEAR_MONTH_DAY_HOUR_MIN, YEAR_MONTH_DAY_HOUR
    ...
    public static class Builder {
        ...
        public static Type type = Type.ALL;//显示类型 默认全部显示
        private int gravity = Gravity.CENTER;//内容显示位置 默认居中
    ...
    private void initView(Context context) {
        ...
        if (customListener == null) {
            ...
            LayoutInflater.from(context).inflate(getContentLayout(), contentContainer);
    ...
    private int getContentLayout() {
        ...
        switch (Builder.type) {
            case YEAR_MONTH:
                layout = R.layout.pickerview_time_my_year_mouth;
                break;
            case YEAR_MONTH_DAY:
                layout = R.layout.pickerview_time_my_year_mouth_day;
                break;
            case YEAR_MONTH_DAY_HOUR:
                layout = R.layout.pickerview_time_my;
                break;
            case YEAR_MONTH_DAY_HOUR_MIN:
                layout = R.layout.pickerview_time_my_hour_min;
                break;
            case HOURS_MINS:
                layout = R.layout.pickerview_time_only_hour_min;
                break;
            default:
                layout = R.layout.pickerview_time_my_year_mouth_day;
                break;
