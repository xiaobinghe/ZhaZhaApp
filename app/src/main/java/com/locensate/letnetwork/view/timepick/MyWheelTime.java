...
public class MyWheelTime {
    ...
    public MyWheelTime(View view, MyTimePickerView.Type type, int gravity, int textSize) {
        super();
        this.view = view;
        this.type = type;
    ...
    public void setPicker(int year, final int month, int day, final int h, int m, final int s) {
        this.hour = h;
     ...
     /*   wv_month.setLabel(context.getString(R.string.pickerview_month));*/
       ...
       /* wv_day.setLabel(context.getString(R.string.pickerview_day));*/
        ...
        if (year == endYear && month + 1 == endMonth && day == endDay) {
            wv_hours.setAdapter(new NumericWheelAdapter(0, hour));
        } else {
            ...
            public void onItemSelected(int index) {
                if (currentYear == endYear) {
                    if (currentMonth == endMonth) {
                        LogUtil.e(TAG, "-------------------currentMonth == endMonth===" + (currentYear == endYear));
                        LogUtil.e(TAG, "-------------------dayNum===" + wv_day.getCurrentItem());
                        if ((wv_day.getCurrentItem() + 1) == endDay) {
                            LogUtil.e(TAG, "-------------------endday===" + endDay);
                            setReHour(0, endHour);
                        } else {
                            setReHour(0, 23);
                        }
    ...
    private void setReHour(int startHour, int endHour) {
