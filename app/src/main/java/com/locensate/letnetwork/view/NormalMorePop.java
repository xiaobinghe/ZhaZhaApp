...
public class NormalMorePop extends PopupWindow {
    private AddPopItemListener addPopItemListener;

    public NormalMorePop(final Activity context, int resId, final OnItemClickListener onItemClickListener) {
